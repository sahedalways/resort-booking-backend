<div>
                ...
                <div class="card-header p-4">
                    <div class="row">
                        <div class="col-md-12" wire:ignore>
                            <input type="text" class="form-control" placeholder="Search by room name."
                                wire:model="search" />
                                ...
                                @foreach ($items as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-bs-toggle="modal" data-bs-target="#editRoom"
    ...
    <div wire:ignore.self class="modal fade" id="addRoom" tabindex="-1" role="dialog" aria-labelledby="addRoom"
                    ...
                    <div class="modal-body">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select class="form-control" wire:model="resort_id" required>
    ...
    <div wire:ignore.self class="modal fade" id="editRoom" tabindex="-1" role="dialog" aria-labelledby="addRoom"
        aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">

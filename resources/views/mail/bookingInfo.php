  ...
  <div class="email-wrapper">
    ...
    <div class="email-body">
      ...
      <div class="booking-info">
        ...
        <div class="info-row"><span class="info-label">Booking Dates:</span> {{ $data['booking']->start_date }} to
        ...
        <div class="info-row"><span class="info-label">Amount:</span> ৳{{ number_format($data['booking']->amount, 2) }}
        </div>
    ...
    <div class="footer">
      <p>
        &copy; {{ date('Y') }} <strong>{{ siteSetting()->site_title ?? 'BookingXpart' }}</strong>. All rights reserved.
      </p>
      <p>
